...
def dropdown_complexity(llm,lang):
    if lang =="en":
        ...
        if 'gpt-4' in llm:
            compexity = st.sidebar.selectbox('Extraktionsfunktionen', ['Informationsseite','Zusammengefasst','Stichpunkte','Wirtschaftlich', 'Technisch','Karteikarten'], key='compexity')
            if compexity == 'Wirtschaftlich':
            ...
            elif compexity == 'Informationsseite':
                ...
                last_text = ''
            elif compexity == 'Zusammengefasst':
            ...
            compexity = st.sidebar.selectbox('Extraktionsfunktionen', ['Informationsseite','Zusammengefasst','Stichpunkte','Wirtschaftlich', 'Technisch'], key='compexity')
            if compexity == 'Wirtschaftlich':
                start_text = 'Inhalt:'
                last_text= '\n Anleitung: Fasse den text für eine Wirtschaftsperson zusammen.'
            elif compexity == 'Technisch':
