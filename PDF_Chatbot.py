...
def cost_calculator(elapsed_times,res):
    if 'gpt' in llm:
        ...
        if llm == 'gpt-4':
            ...
            cost = ((0.01/1000)*anzahl_input)+((0.03/1000)*anzahl_output)
        else:
...
#,on_change=clear_chat_history()
    ...
    selected_model = st.sidebar.selectbox('Choose a Chatbot model', ['GPT-3.5 Turbo - 4k', 'GPT-3.5 Turbo - 16k','GPT 4 - 8k','GPT 4 - 32k','GPT 4 Turbo','Llama2-7B', 'Llama2-13B', 'Llama2-70B'], key='selected_model')
    ...
    if uploaded_file != None:
        ...
        if anzahl_input > 30000 and (llm == "gpt-3.5-turbo" or "Llama" in llm or llm == "gpt-3.5-turbo-16k" or llm == "gpt-4"):
            st.markdown("<span style='color:red; font-weight:bold;'>The text is too long for the model, please use another model like:<br>GPT 4 - Turbo</span>", unsafe_allow_html=True)
        if anzahl_input > 14000 and (llm == "gpt-3.5-turbo" or "Llama" in llm or llm == "gpt-3.5-turbo-16k" or llm == "gpt-4"):
            st.markdown("<span style='color:red; font-weight:bold;'>The text is too long for the model, please use another model like:<br>GPT 4 - 32k<br>GPT 4 - Turbo</span>", unsafe_allow_html=True)
        elif anzahl_input > 6000 and (llm == "gpt-3.5-turbo" or "Llama" in llm or llm == "gpt-4"):
            st.markdown("<span style='color:red; font-weight:bold;'>The text is too long for the model, please use another model like:<br>GPT-3.5 Turbo - 16k<br>GPT 4 - 32k<br>GPT 4 - Turbo</span>", unsafe_allow_html=True)
        elif anzahl_input > 3000 and (llm == "gpt-3.5-turbo" or "Llama" in llm):
            st.markdown("<span style='color:red; font-weight:bold;'>The text is too long for the model, please use another model like:<br>GPT-3.5 Turbo - 16k<br>GPT 4 - 8k<br>GPT 4 - 32k<br>GPT 4 - Turbo</span>", unsafe_allow_html=True)
